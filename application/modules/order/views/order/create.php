...
use app\modules\order\widgets\BuyByCode;
use app\modules\order\widgets\ChooseClient;
...
app\modules\order\assets\CreateOrderAsset::register($this);
$this->registerJs("oak.createorder.updateCartUrl = '".Url::toRoute(['tools/cart-info'])."';");
