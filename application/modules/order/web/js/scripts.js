...
oak.order = {
	...
	outcoming: function() {
		...
		$.post(oak.order.outcomingAction, data, function(json) {
    ...
    updateShippingType: function() {
        jQuery.post(oak.order.updateShippingType, {shipping_type_id: $(this).val()},
            function(json) {
                $('.oak-cart-price>span').html(json.total);
            }, "json");
