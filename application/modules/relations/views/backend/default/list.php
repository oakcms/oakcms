...
<div class="list-index">
    ...
    <?php if(empty($modelList)) { ?>
        <p>Not found</p>
    <?php } ?>
    <ul class="oakcms-relations-list">
        <?php foreach($modelList as $model) { ?>
            <li>
                <a href="#" data-model="<?=$model::className();?>" data-id="<?=$model->getId();?>" data-name="<?=Html::encode($model->getName());?>" class="oakcms-relations-variant ">
                    <div class="row">
