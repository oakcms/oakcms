...
!function (t, n) {
    angular.module("widgetkit").run(["$rootScope", "$rootElement", "$timeout", "$filter", function (e, o, a, i) {
        ...
        var c = t("body.com_widgetkit"),
            ...
            u = '<div id="toolbar-options"><button class="btn btn-circle btn-default btn-sm"><span class="fa fa-cogs"></span> ' + i("trans")("Options") + "</button></div>";
