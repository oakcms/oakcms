...
!function (t, n) {
    angular.module("widgetkit").run(["$rootScope", "$rootElement", "$timeout", "$filter", function (e, o, a, i) {
        ...
        var c = t("body.com_widgetkit"),
            ...
            p = '<button class="btn btn-small btn-success"></span>' + i("trans")("New") + "</button>",

            d = '<button class="btn btn-circle btn-success btn-sm"><span class="icon-apply icon-white"></span> ' + i("trans")("Save") + '</button>' +
            ...
            u = '<button class="btn btn-circle btn-default btn-sm"><span class="fa fa-cogs"></span> ' + i("trans")("Options") + "</button>";
