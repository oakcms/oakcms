...
!function (t, n) {
    angular.module("widgetkit").run(["$rootScope", "$rootElement", "$timeout", "$filter", function (e, o, a, i) {
        ...
        var c = t("body.com_widgetkit"),
            ...
            p = '<div class="actions pull-right" id="toolbar-create">' +
                    '<button class="btn btn-small btn-success"></span>' + i("trans")("New") + "</button>" +
                "</div>",

            d = '<div class="actions pull-right" id="toolbar-apply">' +
                    '<button class="btn btn-circle btn-success btn-sm"><span class="icon-apply icon-white"></span> ' + i("trans")("Save") + '</button>' +
                    '<button class="btn btn-circle btn-success btn-sm"><span class="icon-save"></span> ' + i("trans")("Save & Close") + '</button>' +
                    '<button class="btn btn-circle btn-default btn-sm"><span class="icon-cancel"></span> ' + i("trans")("Close") + "</button>" +
                "</div>",

            u = '<div class="actions pull-right" id="toolbar-options"><button class="btn btn-circle btn-default btn-sm"><span class="icon-options"></span> ' + i("trans")("Options") + "</button></div>";
