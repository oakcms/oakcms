...
<ul id="wk-<?php echo $settings['id']; ?>" class="uk-switcher uk-margin-top uk-text-<?php echo $settings['text_align']; ?>" data-uk-check-display>
<?php foreach ($items as $item) : ?>
    ...
    <li>
        ...
        <div class="uk-margin-top"><?php echo $item['content']; ?></div>
        <?php endif; ?>

        <?php if ($socials && ($settings['media_overlay'] != 'social-buttons')) : ?>
        <div class="uk-grid uk-grid-small uk-flex-<?php echo $settings['text_align']; ?> uk-margin-top" data-uk-grid-margin><?php echo $socials; ?></div>
        <?php endif; ?>
        ...
        <div class="uk-margin-top uk-text-center"><?php echo $media; ?></div>
        <?php endif; ?>
