...
<div class="{wk}-accordion {wk}-text-<?php echo $settings['text_align']; ?> <?php echo $settings['class']; ?>" data-{wk}-accordion="<?php echo $options; ?>">
...
<?php foreach ($items as $i => $item) :
    ...
    <h3 class="{wk}-accordion-title"><?php echo $item['title']; ?></h3>
