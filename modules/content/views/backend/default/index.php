                ...
                [
                    ...
                    'value' => function ($model, $index, $widget) {
                        return Html::checkbox('', $model->status == ContentArticles::STATUS_PUBLISHED, [
                            ...
                            'data-link' => \yii\helpers\Url::to(['/admin/content/default']),
                            'data-reload' => '0'
                        ]);
                    },
                    'enum' => [
...
<script>
    function deleteA() {
        ...
        window.location.href = '/admin/content/default/delete-ids?id=' + keys.join();
    }
    function publishedA() {
        var keys = $('#grid').yiiGridView('getSelectedRows');
        window.location.href = '/admin/content/default/published?id=' + keys.join();
    }
    function unpublishedA() {
        var keys = $('#grid').yiiGridView('getSelectedRows');
        window.location.href = '/admin/content/default/unpublished?id=' + keys.join();
    }
</script>
