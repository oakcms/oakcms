...
class ContentCategorySearch extends ContentCategory
{
    ...
    {
        return [
            [['id', 'status', 'created_at', 'updated_at', 'root', 'lft', 'rgt', 'lvl', 'icon_type', 'active', 'selected', 'disabled', 'readonly', 'visible', 'collapsed', 'movable_u', 'movable_d', 'movable_l', 'movable_r', 'removable', 'removable_all'], 'integer'],
            [['icon'], 'safe'],
        ];
    }
