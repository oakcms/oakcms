...
if (!$double) {
    ...
    if ($_POST) {
        ...
        // subject
        $subject = "Коцюбинський форма FAQ";
        ...
        if (!$send_mail) {
            ...
            $url = 'https://docs.google.com/forms/d/e/1FAIpQLSfXi6MgdU2iji0lkYRk10Cjyy7860h3yVE5fZlQWWb-lC5iQw/formResponse'; // куда слать, это атрибут action у гугл формы
...
function getNextNumber() {
    $count = (int)file_get_contents('id_faq.txt');
    $count+=1;
